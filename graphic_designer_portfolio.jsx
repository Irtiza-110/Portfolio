    ...
    <div className="bg-white text-black min-h-screen overflow-x-hidden scroll-smooth">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-32 md:pt-40 relative overflow-hidden">
        ...
        <div className="mt-10 relative z-10">
          <a
            href="https://www.fiverr.com/s/wkvD3jA"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-black text-white px-8 py-4 rounded-full hover:scale-105 hover:shadow-2xl transition"
          >
            Hire Me on Fiverr
          </a>
        </div>
      ...
      <section id="contact" className="py-24 px-6 text-center bg-gradient-to-b from-white to-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <a href="https://www.fiverr.com/s/wkvD3jA" target="_blank" className="bg-black text-white px-8 py-4 rounded-full">Fiverr</a>
          <a href="https://www.linkedin.com/in/syed-irtiza-haider-kazmi-92a93228a" target="_blank" className="border px-8 py-4 rounded-full">LinkedIn</a>
          <a href="https://wa.me/923489970649" target="_blank" className="border px-8 py-4 rounded-full">WhatsApp</a>
        </div>
      </section>
